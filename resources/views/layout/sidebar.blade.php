    ...
    <aside id="sidebar-wrapper">
        ...
        <ul class="sidebar-menu">
            <li class="menu-header">M E N U</li>
                ...
                <li><a class="nav-link" href="{{ URL::to('History') }}"><i class="fab fa-readme"></i> <span>History</span></a></li>
                <li><a class="nav-link" href="{{ URL::to('') }}"><i class="fa fa-power-off"></i> <span>Logout</span></a></li>
            </li>
        </ul>
    </aside>
</div>
